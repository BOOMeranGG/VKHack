...
public class MainActivity extends AppCompatActivity {
    ...
    private void setRecordIcon(boolean record) {
        if (record) {
            mBinding.recordBtn.setBackground(VectorDrawableCompat.create(getResources(), R.drawable.recording, getTheme()));
        } else {
            mBinding.recordBtn.setBackground(VectorDrawableCompat.create(getResources(), R.drawable.standby, getTheme()));
        }
    }
